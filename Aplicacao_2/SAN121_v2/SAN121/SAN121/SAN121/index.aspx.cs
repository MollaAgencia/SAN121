...
namespace SAN121
{
    public partial class index : System.Web.UI.Page
    {
        ...
        {
            bool ret = false;
            string listaEmail = "WORK_VISITADO";
            string dadosPOST = "{\"nm_lista\":\"" + listaEmail + "\",\"campos\":\"nm_email;nome;CNPJWORKVISITADO\",\"valor\":\"" + pEmail + ";" + pNpme + ";" + pCNPJ.Replace(".", "").Replace("-", "").Replace("/", "") + "\"}";
