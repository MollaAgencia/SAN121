			...
			<div class="my-auto mx-md-4 pt-4 pt-md-0">
				...
				<div class="row mx-0">
					<div class="col-12 col-sm-12 col-md-12 col-lg">
						<h2 class="font-weight-bold mb-3">Comece 2020 em mais<br class="d-none d-sm-none d-md-block"> uma parceria de sucesso<br class="d-none d-sm-none d-md-block"> com a <span class="text-blue">SANOFI!</span></h2>
					...
					<div class="col-12 col-sm-12 col-md-12 col-lg bg-blue pt-4 px-md-5 pb-3">
						...
						<div id="form-cadastro" class="mt-3">
							...
							<div class="text-center mt-4">
								<button id="btnEnviar" class="btn btn-white border-0 rounded-0">Enviar</button>
							</div>
						</div>
					</div>
				</div>
